...
import android.os.Debug;fdsaaf 
...
ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener {
	...
	public PLA_AbsListView(Context context) {
		...
		TypedArray a = context.obtainStyledAttributes(ResourceUtil.getResourceDeclareStyleableIntArray(context, "View"));
		initializeScrollbars(a);
		a.recycle();
	}

	public PLA_AbsListView(Context context, AttributeSet attrs) {
		this(context, attrs, ResourceUtil.getResId(context, "absListViewStyle", "attr"));
	}
	...
	public PLA_AbsListView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				ResourceUtil.getResourceDeclareStyleableIntArray(context, "AbsListView"), defStyle, 0);

		Drawable d = a.getDrawable(ResourceUtil.getResId(context, "AbsListView_listSelector", "styleable"));
		if (d != null) {
			setSelector(d);
		}

		mDrawSelectorOnTop = a.getBoolean(
				ResourceUtil.getResId(context, "AbsListView_drawSelectorOnTop", "styleable"), false);

		boolean stackFromBottom = a.getBoolean(ResourceUtil.getResId(context, "AbsListView_stackFromBottom", "styleable"), false);
		setStackFromBottom(stackFromBottom);

		boolean scrollingCacheEnabled = a.getBoolean(ResourceUtil.getResId(context, "AbsListView_scrollingCache", "styleable"), true);
		setScrollingCacheEnabled(scrollingCacheEnabled);

		int transcriptMode = a.getInt(ResourceUtil.getResId(context, "AbsListView_transcriptMode", "styleable"),
				TRANSCRIPT_MODE_DISABLED);
		setTranscriptMode(transcriptMode);

		int color = a.getColor(ResourceUtil.getResId(context, "AbsListView_cacheColorHint", "styleable"), 0);
		setCacheColorHint(color);

		boolean smoothScrollbar = a.getBoolean(ResourceUtil.getResId(context, "AbsListView_smoothScrollbar", "styleable"), true);
