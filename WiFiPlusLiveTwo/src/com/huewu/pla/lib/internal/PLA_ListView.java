...
public class PLA_ListView extends PLA_AbsListView {
	...
	public PLA_ListView(Context context, AttributeSet attrs) {
		this(context, attrs, ResourceUtil.getResId(context, "listViewStyle", "attr"));
	}
	...
	public PLA_ListView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				ResourceUtil.getResourceDeclareStyleableIntArray(context, "ListView"), defStyle, 0);
		...
		final Drawable osHeader = a.getDrawable(
				ResourceUtil.getResId(context, "ListView_overScrollHeader", "styleable"));
		if (osHeader != null) {
			setOverscrollHeader(osHeader);
		}

		final Drawable osFooter = a.getDrawable(
				ResourceUtil.getResId(context, "ListView_overScrollFooter", "styleable"));
		if (osFooter != null) {
		...
		final int dividerHeight = a.getDimensionPixelSize(
				ResourceUtil.getResId(context, "ListView_dividerHeight", "styleable"), 0);
		if (dividerHeight != 0) {
			setDividerHeight(dividerHeight);
		}

		mHeaderDividersEnabled = a.getBoolean(ResourceUtil.getResId(context, "ListView_headerDividersEnabled", "styleable"), true);
		mFooterDividersEnabled = a.getBoolean(ResourceUtil.getResId(context, "ListView_footerDividersEnabled", "styleable"), true);
