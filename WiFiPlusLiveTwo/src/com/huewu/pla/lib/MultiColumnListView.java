...
public class MultiColumnListView extends PLA_ListView {
	...
	public List<String> sourceImageFileNames = new ArrayList<String>();
	
	public Vector itemVector = new Vector();
	public List<SearchFileDetailStatusEntity> filterResult = new ArrayList<SearchFileDetailStatusEntity>();
