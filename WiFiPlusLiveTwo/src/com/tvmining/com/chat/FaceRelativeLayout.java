...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	public void KeyBoardCancle() {
		  ...
		  View view = Constant.activity.getWindow().peekDecorView();
		  if (view != null) {

		   InputMethodManager inputmanger = (InputMethodManager) Constant.activity.getSystemService(Constant.activity.INPUT_METHOD_SERVICE);
	...
	public void resetEditStatus(){
		...
		Constant.activity.hideInteractMaskView();
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (!TextUtils.isEmpty(emoji.getCharacter())) {
			...
			// 显示图片的文字
			et_sendmessage.append(emoji.getCharacter());
		}
