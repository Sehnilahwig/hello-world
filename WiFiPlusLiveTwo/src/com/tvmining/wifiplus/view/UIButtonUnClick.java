...
public class UIButtonUnClick extends RelativeLayout {

	private LayoutInflater mInflater;
	private RelativeLayout mButtonContainer;
	private ClickListener mClickListener;
	
	public UIButtonUnClick(Context context, AttributeSet attrs) {
		super(context, attrs);
//		this.setClickable(true);
		mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mButtonContainer = (RelativeLayout) mInflater.inflate(R.layout.list_item_single_unclick, null);
		...
		mButtonContainer.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick(View view) {
				if(mClickListener != null)
					mClickListener.onClick(UIButtonUnClick.this);
			}			
		});		
		addView(mButtonContainer, params);
	}	
	
	public UIButtonUnClick(Context context) {
		super(context);
//		this.setClickable(true);
		mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mButtonContainer = (RelativeLayout) mInflater.inflate(R.layout.list_item_single_unclick, null);
