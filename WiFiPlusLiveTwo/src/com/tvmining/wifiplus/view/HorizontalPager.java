...
public final class HorizontalPager extends ViewGroup {
     ...
     */
    private void init() {
    	DecelerateInterpolator inpl=new DecelerateInterpolator();	
        mScroller = new Scroller(getContext(),inpl);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mTouchState == TOUCH_STATE_HORIZONTAL_SCROLLING) {
                    ...
                    if (deltaX < 0) {
                    	...
                    	Log.d("HorizontalPager", "right");
                        if (scrollX > 0) {
                        	direction = 1;
                            scrollBy(Math.max(-scrollX, deltaX), 0);
                            if(onScreenChangeListenerDataLoad != null){
            					onScreenChangeListenerDataLoad.onScreenChange(mCurrentScreen-1,1);
            				}
                        }
                    } else if (deltaX > 0) {
                    	Log.d("HorizontalPager", "left");
                        ...
                        if (availableToScroll > 0) {
                            ...
                            if(onScreenChangeListenerDataLoad != null){
            					onScreenChangeListenerDataLoad.onScreenChange(mCurrentScreen+1,0);
            				}
                        }
                    }
                }
...
//                    	activity.resetItems();
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            if (mOnScreenSwitchListener != null) {
                mOnScreenSwitchListener.onScreenSwitched(mCurrentScreen,direction);
            }
    ...
    public static interface OnScreenSwitchListener {
         ...
         */
        void onScreenSwitched(int screen,int direction);
    }
    
  //动态数据监听
  	public static interface OnScreenChangeListenerDataLoad {
  		void onScreenChange(int currentIndex,int direction);
  	}
  	public OnScreenChangeListenerDataLoad onScreenChangeListenerDataLoad;
