...
public class ColorSelector extends RelativeLayout
{
    ...
    public void initialize(Context context)
    {
        ...
        RelativeLayout.LayoutParams btnDoneparams = new RelativeLayout.LayoutParams(80, 60);
        left += 5;
        ...
        RelativeLayout.LayoutParams btnCancelparams = new RelativeLayout.LayoutParams(80, 60);
        left += 80;
