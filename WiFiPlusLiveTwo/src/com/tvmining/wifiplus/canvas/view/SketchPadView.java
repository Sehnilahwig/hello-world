package com.tvmining.wifiplus.canvas.view;
...
import com.tvmining.wifiplus.canvas.interfaces.ISketchPadCallback;
import com.tvmining.wifiplus.canvas.interfaces.ISketchPadTool;
import com.tvmining.wifiplus.canvas.interfaces.IUndoCommand;
import com.tvmining.wifiplus.canvas.util.BitmapUtil;
import com.tvmining.wifiplus.canvas.util.CommonDef;
import com.tvmining.wifiplus.canvas.util.SketchPadEraser;
import com.tvmining.wifiplus.canvas.util.SketchPadPen;
 ...
 *
 */
public class SketchPadView extends ImageView implements IUndoCommand
{
	...
	public int parentMeasuredHeight;
	private String from;
    ...
    public boolean getDrawStrokeEnable()
    {
        return m_isEnableDraw;
    }
    ...
    public void prepareToDraw(MotionEvent event){
    	m_isTouchUp = false;
    ...
    protected void onDraw(Canvas canvas)
    {
    	try{
        	...
        	if(!(this.attacher != null && this.attacher.canZoom())){
    		...
    		Log.e("SketchPadView", "Cannot draw recycled bitmaps");
    	}
    }
