 ...
 */
public class LocalSwipeListViewTouchListener implements View.OnTouchListener {
     ...
     */
    public LocalSwipeListViewTouchListener(LocalSwipeListView swipeListView, int swipeFrontView, int swipeBackView) {
        ...
        return new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView absListView, int scrollState) {
                ...
                if (scrollState != AbsListView.OnScrollListener.SCROLL_STATE_FLING && scrollState != SCROLL_STATE_TOUCH_SCROLL) {
                    ...
                    downPosition = ListView.INVALID_POSITION;
                    Log.i("CCCC", "onScrollStateChanged");
                    swipeListView.resetScrolling();
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    boolean allowSwipe = swipeListView.getAdapter().isEnabled(childPosition) && 
                    		swipeListView.getAdapter().getItemViewType(childPosition) >= 0&&((LocalPackageAdapter)swipeListView.getAdapter()).isTouch(childPosition);
...
//                }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                Log.i("BBBB", "1111 "+(downPosition == ListView.INVALID_POSITION)+" =swiping " + swiping);
