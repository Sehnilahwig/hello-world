...
package com.tvmining.wifiplus.swipelistview;
 ...
 */
public class LocalSwipeListView extends ListView {
     ...
     */
    private LocalSwipeListViewTouchListener touchListener;
     ...
     */
    public LocalSwipeListView(Context context, int swipeBackView, int swipeFrontView) {
        super(context);
     ...
     */
    public LocalSwipeListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
     ...
     */
    public LocalSwipeListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
        	...
        	swipeFrontView = R.id.frontview;
            swipeBackView = R.id.backview;
        ...
        Log.i("DDDD", "swipeFrontView = "+swipeFrontView +"   ----   swipeBackView"+swipeBackView);
        final ViewConfiguration configuration = ViewConfiguration.get(getContext());
        touchSlop = ViewConfigurationCompat.getScaledPagingTouchSlop(configuration);
        touchListener = new LocalSwipeListViewTouchListener(this, swipeFrontView, swipeBackView);
    ...
    public boolean isHaveItemOpened(){
