...
public interface ViewCreator<E> {
    ...
    View createView(LayoutInflater inflater, int position, E data,ImageLoader imageLoader,boolean mBusy,ListImageFetcher mImageFetcher);
    /**
    ...
    void updateView(View view, int position, E data,ImageLoader imageLoader,boolean mBusy,ListImageFetcher mImageFetcher);
    /**
