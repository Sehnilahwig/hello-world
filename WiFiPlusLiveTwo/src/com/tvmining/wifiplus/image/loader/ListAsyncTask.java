 ...
 */
public abstract class ListAsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = ListUtils.hasHoneycomb() ? new SerialExecutor() :
     ...
     *         {@link ListAsyncTask.Status#RUNNING} or {@link ListAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final ListAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final ListAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final ListAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(ListAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
