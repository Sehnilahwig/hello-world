...
public class AutoRemoteControlTask extends AsyncTask<Object, Object, Object> {
	...
	public AutoRemoteControlTask(Context context, String cmdType, String body,boolean isVibrator) {
	...
	protected Object doInBackground(Object... params) {
		...
		}else if(Constant.allScreenList!=null && Constant.allScreenList.size() > 0){
			CommandEntity oneCmd = new CommandEntity();
			oneCmd.CmdTYPE = cmdType;
			oneCmd.body = body;
			oneCmd.OBJ = Constant.allScreenList.get(0).CmdObjToMy;//指定匹配屏幕
			Integer reTry = 1;
			if(params != null && params.length > 0){
				reTry = (Integer) params[0];
			}
