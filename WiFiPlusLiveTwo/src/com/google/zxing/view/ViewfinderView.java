...
public final class ViewfinderView extends View {
    ...
    private Bitmap scanBorderBitmap;
    private Bitmap scanLineBitmap;
    private int scanLinePosition = -1;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        scanBorderBitmap = ((BitmapDrawable)resources.getDrawable(R.drawable.qrcod_scan_border)).getBitmap();
    ...
    public void onDraw(Canvas canvas) {
    	...
    	if(cameraManager != null){
            ...
            if (resultBitmap != null) {
                ...
                scanBorderBitmap = ImageUtil.zoomBitmap(scanBorderBitmap, frame.right-frame.left+40, frame.bottom-frame.top+40);
                canvas.drawBitmap(scanBorderBitmap, frame.left-20, frame.top-20, null);
                
                scanLineBitmap = ImageUtil.zoomBitmap(scanLineBitmap, frame.right-frame.left, 30);
                if(scanLinePosition == -1 || scanLinePosition >= frame.bottom-scanLineBitmap.getHeight()){
                	scanLinePosition = frame.top - scanLineBitmap.getHeight();
                }else{
                	scanLinePosition = scanLinePosition + (frame.bottom-frame.top) / 50;
                }
                canvas.drawBitmap(scanLineBitmap, frame.left, scanLinePosition, null);
